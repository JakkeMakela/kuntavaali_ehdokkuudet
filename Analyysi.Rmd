...
plotIka(kvdata, caption = "Ehdokkaiden ikäjakaumat kuntavaaleissa" ,
        ymin=30, ymax=70) %>% print()

plotIka(ekdata, caption="Ehdokkaiden ikäjakaumat ek-vaaleissa",
        ymin=30, ymax=70) %>% print()
...
plotIkaEffect(kvtilasto %>% filter(ika.ka <= 58), ymin=30, ymax = 80,
